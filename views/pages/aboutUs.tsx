        ...
        <div className="custom-container">
          <Row>
            ...
            <Col lg="6">
              ...
              <p>
                {" "}
                being able to do what we like best, every pleasure is to be <b>welcomed</b> and every pain avoided. But in certain circumstances and owing to the claims of duty or the obligations of
                business it will frequently occur that pleasures have to be repudiated and annoyances accepted. The wise man therefore always holds in these matters to this principle of selection: he
                rejects pleasures to secure other greater pleasures, or else he endures pains to avoid <b>worse</b> pains.
              </p>
            </Col>
          </Row>
        </div>
